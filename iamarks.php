...
<head>
    ...
    <title><?php echo $user_data['username']; ?>'s Marks</title>
    </head>
    <style>
    * {
        margin: 0;
...
<body>
    <?php
        ...
        $query = mysqli_query($con,"select Course_code, Course_name, IA_1Marks, IA_2Marks from iamarks where USN = '$user_data[USN]'");
